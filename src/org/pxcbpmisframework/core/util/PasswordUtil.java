...
public class PasswordUtil {
	...
	/**
	 * Made by :panxiaochao 
	 * 提供24、32位的md5加密，默认32位
	 */
	@SuppressWarnings("unused")
	public static String PasswordMd5(String plainText) {
		...
		try {
			...
			for (int offset = 0; offset < b.length; offset++) {
			 ...
			 //System.out.println("result: " + buf.toString().substring(8,32));// 24位的加密

		} catch (NoSuchAlgorithmException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		return buf.toString().substring(8,32);
	}
