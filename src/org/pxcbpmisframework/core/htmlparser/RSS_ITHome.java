...
public class RSS_ITHome {
	private static final Logger logger = Logger.getLogger(RSS_ITHome.class);
	private static String url = "http://www.ithome.com/rss/";
	public static String head = "IT之家";
	private static String path = "E://index//";

	public static void main(String[] args) {
		RSS_ITHome.RssITHome();
	}

	public static void RssITHome() {
